                                    ...
                                    <div class="card-body">
                                        ...
                                        <form>
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="mb-3">
                                                        <label for="Siteowner" class="form-label">Site Owner Name</label>
                                                        <input type="text" class="form-control" id="Siteowner">
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="mb-3">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <div class="mb-3">
                                                        <label for="sitecity" class="form-label">Site City</label>
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="mb-3">
                                                        <label for="Siteother" class="form-label">Other</label>
                                                        <input type="text" class="form-control" id="Siteother">
                                                    </div>
                                                </div>
                                            </div>
                                            <div>
