...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="white-box">
                <form action="{{ route('control.panel.blog.categories.store') }}" name="addfrm" id="addfrm" method="POST" enctype="multipart/form-data" autocomplete="off">
                    @csrf
                    ...
                    <div class="form-actions">
                        ...
                        <a href="{{ route('control.panel.blog.categories')}}" class="btn btn-default">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
            ...
            $("#addfrm").validate({
                ...
                rules: {
                    name:{
                        required:true,
                        remote: {
                            url: '{!! route("control.panel.blog.categories.exists") !!}',
                            type: "POST",
                            data:{id:$("#id").val()},
