                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Truck</h4>
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <select id="trucktype" class="form-select">
                                                            ...
                                                            <option>Reti Truck</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="mb-3">
                                                        <label for="truckother" class="form-label">Other</label>
                                                        <input type="text" class="form-control" id="truckother">
                                                    </div>
                                                </div>
                                            </div>
                                            <div>
